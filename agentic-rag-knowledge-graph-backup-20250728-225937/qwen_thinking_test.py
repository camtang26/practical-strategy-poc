...
async def test_qwen_model(model_name: str, thinking_mode: bool = False):
    """Test Qwen model with timing and tool usage analysis."""
    
    print(f"\n{'='*80}")
    print(f"Testing: {model_name} (thinking_mode={thinking_mode})")
...
async def main():
    # Test thinking model
    await test_qwen_model("qwen3-235b-a22b-thinking-2507", thinking_mode=True)
